...
from djangoMedical.models import Company, CompanyBank, Medicine, MedicalDetails, Employee, Customer, Bill, \
...
class CompanyBankSerializer(serializers.ModelSerializer):
    ...
    #     response['company']=CompanySerliaze(instance.company_id).data
    #     return response
