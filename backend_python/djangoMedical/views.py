...
from djangoMedical.models import Company , CompanyBank, Medicine, MedicalDetails, CompanyAccount, Employee, \
    EmployeeBank, EmployeeSalary, CustomerRequest, Bill, BillDetails
from djangoMedical.serialize import CompanySerliazer ,  CompanyBankSerializer, MedicineSerliazer, \
